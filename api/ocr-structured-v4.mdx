...
<CardGroup cols={2}>
  <Card title="Reconciliation Engine" icon="calculator" href="/concepts/reconciliation-v4">
    Deep dive into v4 reconciliation logic
  </Card>
  <Card title="Integration Guide" icon="code" href="/integration/v4-workflow">
    Build a complete v4 extraction workflow
  </Card>
  <Card title="UI Components" icon="window" href="/components/invoice-viewer-v4">
    Display v4 data with pre-built components
  </Card>
  <Card title="Testing" icon="vial" href="/testing/api-routes">
